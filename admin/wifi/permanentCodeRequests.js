...
window.showWifiQrModal = function(ssid, code) {
  const qrString = `WIFI:T:WPA;S:${ssid};P:${code};;`;
  Swal.fire({
...
// getRelativeTimeString → provided by global /style/js/formatDate.js
    ...
    renderUniversalPagination({
      ...
      onPageChange: (newPage, newSize) => {
        ...
        if (newSize && newSize !== pageSize) {
          pageSize = newSize;
          localStorage.setItem('wifiPermPageSize', pageSize);
        }
        applyFilters();
        updateUrlParams();
      },
